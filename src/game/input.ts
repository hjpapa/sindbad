export type Action = 'left' | 'right' | 'down' | 'jump' | 'primary' | 'attack' | 'dodge' | 'interact' | 'cycle' | 'pause' | 'map' | 'skill';
const keymap: Record<string, Action> = { KeyR: 'skill', ArrowLeft: 'left', KeyA: 'left', ArrowRight: 'right', KeyD: 'right', ArrowDown:'down', KeyS:'down', Space: 'primary', KeyK: 'jump', KeyW: 'jump', ArrowUp: 'jump', KeyJ: 'attack', KeyL: 'dodge', ShiftLeft: 'dodge', ShiftRight: 'dodge', KeyE: 'interact', KeyQ: 'cycle', Escape: 'pause', KeyM: 'map' };
export class Input {
