export type Action = 'left' | 'right' | 'jump' | 'attack' | 'dodge' | 'interact' | 'cycle' | 'pause' | 'map';
const keymap: Record<string, Action> = { ArrowLeft: 'left', KeyA: 'left', ArrowRight: 'right', KeyD: 'right', Space: 'jump', KeyK: 'jump', KeyW: 'jump', ArrowUp: 'jump', KeyJ: 'attack', KeyL: 'dodge', ShiftLeft: 'dodge', ShiftRight: 'dodge', KeyE: 'interact', KeyQ: 'cycle', Escape: 'pause', KeyM: 'map' };
export class Input {
