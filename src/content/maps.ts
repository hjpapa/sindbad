...
export const maps: Record<string, MapDef> = {
    ...
    S03: { id: 'S03', width: 4800, theme: 'storm', objective: '피뢰 장치 2개 수리 → 폭풍 수정 → 돛대 위기 → 구명 밧줄',
        platforms: [ground(0, 1700), ground(1820, 1430), ground(3370, 1430), { x: 740, y: 528, w: 240, h: 80 }, { x: 2100, y: 528, w: 256, h: 80 }, { x: 2390, y: 520, w: 176, h: 24 }, { x: 2630, y: 448, w: 200, h: 24 }, { x: 3920, y: 528, w: 200, h: 80 }],
