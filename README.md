...
한국어 횡스크롤 액션 어드벤처의 첫 구현입니다. M0 + M1에 이어 M2 S04~S07까지 구현했으며 실제 맵은 S01~S07입니다. 전체 36개 스테이지는 설계 데이터로 등록되어 있으며 S08~S36은 개발 중으로 잠겨 있습니다. 최종 웹툰 아트가 아닌 `ART_DRAFT` 버전입니다.
...
- `src/content/maps.ts`: S01~S07의 실제 지형·적·장치·하트·안전 체크포인트.
...
S05 완료 후 S06에서 횃불 세 곳을 조사하고 각 화로에 불씨를 옮기세요. 정령 다섯을 진정시키면 라흐가 T01과 W03을 확정 지급합니다. E 점화는 무료이며, R 파동 사용 2초 후 MP가 초당 5씩 회복됩니다. S07은 공기방울 보호가 필요합니다. 파도 예고 때 밧줄 가까이에서 E를 누르고 기다리거나 높이 점프하세요. 마지막 닻에서 수정 동굴 입구를 저장합니다. S08~S36은 아직 개발 중입니다.
