...
| 이단 점프·비행·수영 | T03 보유 후 공중 Space, 비행/수영 구간에서 방향키 |
...
실제 검증 결과와 남은 범위는 `PROJECT_STATUS.md`, `docs/PLAYTEST_LOG.md`를 확인하세요. T01 파동·점화와 T02 환영 해제를 구현했고 T03~T07 능력은 아직 미구현이며 S05의 공기방울과 S16의 자유 수영은 별도 조건으로 등록했습니다.
